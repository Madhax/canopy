...
CODE_MESSAGES: dict[str, str] = {
    ...
    "DEP_DANGLING": (
        "Dependency endpoint refers to an agent or child team that does not exist here."
    ),
    ...
    "CONNECTOR_GRANT_DISABLED": "The role grants a connector capability the team's instance "
